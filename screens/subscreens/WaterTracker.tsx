        ...
        <div className="flex flex-col min-h-screen bg-background-dark">
            ...
            <div className="flex-1 overflow-y-auto">
                ...
                <div className="flex justify-center gap-4 px-4">
                    {[200, 350, 500].map(amt => (
                        <button key={amt} className="px-6 py-2 rounded-full bg-blue-500/20 text-blue-400 font-bold border border-blue-500/30 hover:bg-blue-500 hover:text-white transition-colors cursor-pointer">
                            +{amt}ml
                        </button>
                    ))}
                </div>
                ...
                <div className="p-4 mt-6">
                     <button className="w-full h-14 bg-blue-600 rounded-xl text-white font-bold flex items-center justify-center gap-2 cursor-pointer shadow-lg hover:brightness-110 active:scale-[0.98]">
